...
class Principal():
     ...
     def inicio(self):
          Label(self.ventana, text="Programa de Python con TKInter").place(x=100, y=20)# x cplumna y fila
          Label(self.ventana, text="Programa de Python con TKInter").place(x=50, y=50)
