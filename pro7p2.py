...
class Principal():
    ...
    def inicio(self):
        ...
        l1.place(row=1,column=2)
        l2= Label(self.ven, text="Escribe un numero")
        l2.place(row=3, column=1, padx=15 , pady=10)
        Label(self.ven, text="").place(row=2,column=2)
        self.n1 = Entry(self.ven)
        self.n1.place(row=3, column=2)
        
        l3 = Label(self.ven, text="Escribe otro numero")
        l3.place(row=1, column=2, padx=5 , pady=5)
        Label(self.ven, text="").place(row=4,column=2)
        self.n2 = Entry(self.ven)
        self.n2.place(row=5, column=2)
        b1 = Button(self.ven,text="Agregar", command=self.agregar)
        b1.place(row=6, column=1, pady=10)
        b2 = Button(self.ven,text="Mayor", command=self.mayor)
        b2.place(row=6, column=2)
        b3 = Button(self.ven,text="Menor")
        b3.place(row=6, column=3, padx=10)
        b4 = Button(self.ven,text="Salir", command=self.salir)
        b4.place(row=6, column=4, padx=25)
        self.listaElementos = Label(self.ven, text="")
        self.listaElementos.place(row=8,column=2, pady=15)
        self.listview = Listbox(self.ven, height=10,
                                width=15, bg='black',
                                activestyle= "dotbox", fg="red")
        self.listview.place(row=2,column=4)
